...
public class SHA2 {
        ...
        private static byte[] digest256(byte[] message) {
                ...
                for (int i = 0; i < padded.length / 64; i++) {
                        ...
                        System.arraycopy(padded, 64 * i, block, 0, 64);
                        System.out.print(padded[0]);
                        System.out.print(padded[1]);
                        if(i==0){
                        	//System.out.print(block[0]);
                        	//System.out.print(block[0]);
//                        	char[] inputchar =Hex.encodeHex(block);
...
//                        		temp = inputchar[k] ;
//                        		temp2 = inputchar[k+1];
//                        		inputchar[k] = inputchar[63-k-1];
//                        		inputchar[k+1] = inputchar[63-k];
//                        		inputchar[63-k-1] = temp;
//                        		inputchar[63-k] =temp2;
//                        	}
                        	//System.out.print(inputchar);
                        	System.out.format("blockstart\n");
                        	
                        	System.out.println(Hex.encodeHex(block));
                        	System.out.format("blockend\n");
                        }
                        for (int j = 0; j < 16; j++) {
                                words[j] = 0;
                                for (int k = 0; k < 4; k++) {
                        ...
                        if(i==1){
	                        for (int j= 0; j<64;j++){
	                        	System.out.format("w%d = ", j);
	                        	System.out.println(Hex.encodeHex(A9Utility.intToBytes(words[j])));
	                        }
                        }
                        for (int j = 0; j < 64; j++) {
//                        	if (j==0 ){
//                            	System.out.println(Hex.encodeHex(A9Utility.intToBytes(words[j])));
//                            	System.out.println(Hex.encodeHex(A9Utility.intToBytes(K[j])));
//                        		System.out.format("start\n");
//                        		System.out.println(Hex.encodeHex(A9Utility.intToBytes(a)));
//                        		System.out.println(Hex.encodeHex(A9Utility.intToBytes(b)));
//                        		System.out.println(Hex.encodeHex(A9Utility.intToBytes(c)));
//                        		System.out.println(Hex.encodeHex(A9Utility.intToBytes(d)));
//                        		System.out.println(Hex.encodeHex(A9Utility.intToBytes(e)));
//                        		System.out.println(Hex.encodeHex(A9Utility.intToBytes(f)));
//                        		System.out.println(Hex.encodeHex(A9Utility.intToBytes(g)));
//                        		System.out.println(Hex.encodeHex(A9Utility.intToBytes(h)));
//                        		System.out.format("startend\n");
//                        		
//                        	}
                                s0 = Integer.rotateRight(a, 2) ^ Integer.rotateRight(a, 13) ^ Integer.rotateRight(a, 22);
                                maj = (a & b) ^ (a & c) ^ (b & c);
                                ...
                                t1 = h + s1 + ch + K[j] + words[j];
                                if (j==0){
                            		//System.out.format("afterstart\n");
                                	System.out.format("key = ");
                            		System.out.println(Hex.encodeHex(A9Utility.intToBytes(K[j])));
                            		System.out.format("w = ");
                            		System.out.println(Hex.encodeHex(A9Utility.intToBytes(words[j])));
                            		System.out.format("s1 = ");
                            		System.out.println(Hex.encodeHex(A9Utility.intToBytes(s1)));
                            		System.out.format("ch = ");
                            		System.out.println(Hex.encodeHex(A9Utility.intToBytes(ch)));
                            		System.out.format("temp1 = ");
                            		System.out.println(Hex.encodeHex(A9Utility.intToBytes(t1)));
                            		System.out.format("s0 = ");
                            		System.out.println(Hex.encodeHex(A9Utility.intToBytes(s0)));
                            		System.out.format("maj = ");
                            		System.out.println(Hex.encodeHex(A9Utility.intToBytes(maj)));
                            		System.out.format("temp2 = ");
                            		System.out.println(Hex.encodeHex(A9Utility.intToBytes(t2)));
                            		//System.out.format("afterstartend\n");
                      ...
                      //  System.out.println(Hex.encodeHex(toBytes(a)));
                        System.out.format("finalstart\n");
                        System.out.println(Hex.encodeHex(A9Utility.intToBytes(a)));
                        System.out.println(Hex.encodeHex(A9Utility.intToBytes(b)));
                        System.out.println(Hex.encodeHex(A9Utility.intToBytes(c)));
                        System.out.println(Hex.encodeHex(A9Utility.intToBytes(d)));
                        ...
                        System.out.println(Hex.encodeHex(A9Utility.intToBytes(g)));
                        System.out.println(Hex.encodeHex(A9Utility.intToBytes(h)));
                        System.out.format("finalend\n");
                        System.out.format("hstart\n");
                        System.out.println(Hex.encodeHex(A9Utility.intToBytes(H[0])));
                        System.out.println(Hex.encodeHex(A9Utility.intToBytes(H[1])));
                        System.out.println(Hex.encodeHex(A9Utility.intToBytes(H[2])));
                        System.out.println(Hex.encodeHex(A9Utility.intToBytes(H[3])));
                        System.out.println(Hex.encodeHex(A9Utility.intToBytes(H[4])));
                        System.out.println(Hex.encodeHex(A9Utility.intToBytes(H[5])));
                        System.out.println(Hex.encodeHex(A9Utility.intToBytes(H[6])));
                        System.out.println(Hex.encodeHex(A9Utility.intToBytes(H[7])));
                        System.out.format("hend\n");
                        H[0] += a;
                        H[1] += b;
                        H[2] += c;
                        H[3] += d;
